...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231202160346_AddingBookingStatusValidation")]
    partial class AddingBookingStatusValidation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Models.BookingStatus", b =>
                {
                    ...
                    b.ToTable("bookingStatuses", t =>
                        {
                            t.HasCheckConstraint("CK_AspNetUsers_Gender", "Name IN ('Binding', 'Completed', 'Cancelled')")
                                .HasName("CK_AspNetUsers_Gender1");
                        });
                });
